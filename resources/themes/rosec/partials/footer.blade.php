    ...
    <!-- <div class="container mt-md-5 mb-4 mb-lg-0 position-relative">
        <div class="row m-0 me-xl-0 position-relative footerRow pe-0">
            <div class="col-lg-5 col-xl-4 position-relative accordion-custome">
                ...
                <div class="pb-3 text-md-small f500 accordion-custome-button">Navigation</div>
                <ul class="accordion-custome-body colm-xl-2">
                    ...
                    <li class="mb-2">
                        <a class="text-white text-hover-primary text-md-small f500" href="https://www.crushescorts.com/locations">Locations</a>
                    </li>
                    <li class="mb-2">
                        <a class="text-white text-hover-primary text-md-small f500" href="https://www.crushescorts.com/categories">Categories</a>
                    </li>
                    <li class="mb-2">
                        <a class="text-white text-hover-primary text-md-small f500" href="https://www.crushescorts.com/services">Services</a>
                    </li>
                    <li  class="mb-2">
            ...
            <div class="col-lg-4 col-xl-3 ps-lg-4 ms-auto position-relative accordion-custome">
                ...
                <div class="pb-3 mb-3 f500 accordion-custome-button text-md-small">Contact us</div>
                <div class="accordion-custome-body">
                    ...
                    <a class="text-primary-light f500 text-hover-white text-md-small d-block lh-lg" href="tel:07478770704">07478770704</a>
                    <a class="text-primary-light f500 text-hover-white text-md-small d-block mb-2 lh-lg" href="/cdn-cgi/l/email-protection#c7aea9a1a887a4b5b2b4afa2b4a4a8b5b3b4e9a4a8aa"><span class="__cf_email__" data-cfemail="aec7c0c8c1eecddcdbddc6cbddcdc1dcdadd80cdc1c3">[email&#160;protected]</span></a>
