...
<div class="common-section">
    ...
    <article id="post-{{ $post->id }}" class="text-white max-w-4xl px-5 pb-20 mx-auto prose prose-md dark:prose-invert lg:prose-lg lg:px-0">
        ...
        <div class="max-w-4xl mx-auto mt-6">
            ...
            <h1 class="flex flex-col leading-none text-white">
