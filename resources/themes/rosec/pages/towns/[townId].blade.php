...
new class extends Component
{
    ...
    {
        $this->townId = (int) $townId;
        $this->town = Town::findOrFail($this->townId);
        $this->city = City::findorfail($this->town->city_id);
        $this->escorts = $this->town->users()->get();
    }
...
>
    <x-marketing.sections.town_banner 
        :title="$town->name" 
