<header class="header header-min">
        ...
        <div class="container">
            <div class="header-min-innr position-relative w-100">
                <a class="brand" title="" href="https://www.rosecoco.co.ke"  aria-label="Crush Escorts Home">
                    <img src="/themes/rosec/images/rose_logo_bg.png" width="50%"/>
                </a>                
                <div class="offcanvas offcanvas-start bg-main-bg" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="colm-list colm-xl-7 colm-lg-4">
                                        ...
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>B</b></h5>
                                        <ul class="locations">
                                                ...
                                                <a href="https://www.crushescorts.com/locations/bond-street-escorts" aria-label="Bond Street " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Bond Street </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>C</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                ...
                                                <a href="https://www.crushescorts.com/locations/covent-garden-escorts" aria-label="Covent Garden " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Covent Garden </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>E</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                ...
                                                <a href="https://www.crushescorts.com/locations/edgware-road-escorts" aria-label="Edgware Road " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Edgware Road </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>F</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                <a href="https://www.crushescorts.com/locations/fulham-escorts" aria-label="Fulham " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Fulham </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>G</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                ...
                                                <a href="https://www.crushescorts.com/locations/green-park-escorts" aria-label="Green Park " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Green Park </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>H</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                ...
                                                <a href="https://www.crushescorts.com/locations/hyde-park-corner-escorts" aria-label="Hyde Park Corner " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Hyde Park Corner </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>K</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                ...
                                                <a href="https://www.crushescorts.com/locations/knightsbridge-escorts" aria-label="Knightsbridge " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Knightsbridge </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>L</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                ...
                                                <a href="https://www.crushescorts.com/locations/leicester-square-escorts" aria-label="Leicester Square " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Leicester Square </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>M</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                ...
                                                <a href="https://www.crushescorts.com/locations/mayfair-escorts" aria-label="Mayfair " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Mayfair </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>N</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                <a href="https://www.crushescorts.com/locations/notting-hill-escorts" aria-label="Notting Hill " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Notting Hill </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>O</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                <a href="https://www.crushescorts.com/locations/oxford-street-escorts" aria-label="Oxford Street " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Oxford Street </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>P</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                ...
                                                <a href="https://www.crushescorts.com/locations/portman-square-escorts" aria-label="Portman Square " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Portman Square </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>Q</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                <a href="https://www.crushescorts.com/locations/queensway-escorts" aria-label="Queensway " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Queensway </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>R</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                <a href="https://www.crushescorts.com/locations/royal-oak-escorts" aria-label="Royal Oak " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Royal Oak </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>S</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                ...
                                                <a href="https://www.crushescorts.com/locations/st-johns-wood-escorts" aria-label="St Johns Wood " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">St Johns Wood </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>T</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                ...
                                                <a href="https://www.crushescorts.com/locations/tower-hill-escorts" aria-label="Tower Hill " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Tower Hill </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>V</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
                                                <a href="https://www.crushescorts.com/locations/victoria-escorts" aria-label="Victoria " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Victoria </a>
                                                                        ...
                                                                        <div class="colm-list-item mb-2">
                                        <h5 class="text-uppercase d-flex fs-5 text-primary"><b>W</b></h5>
                                        <ul class="locations">
                                                                                        <li class="mb-3 mb-lg-1">
    ...
    <ul class="locations">
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/blonde-escorts" aria-label="Blonde " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Blonde </a>
        </li>
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/brazilian-escorts" aria-label="Brazilian " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Brazilian </a>
        </li>
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/brunette-escorts" aria-label="Brunette " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Brunette </a>
        </li>
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/busty-escorts" aria-label="Busty " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Busty </a>
        </li>
            </ul>
</div>
<div class="colm-list-item mb-2">
    ...
    <ul class="locations">
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/couple-escorts" aria-label="Couple " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Couple </a>
        </li>
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/curvy-escorts" aria-label="Curvy " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Curvy </a>
        </li>
            </ul>
</div>
<div class="colm-list-item mb-2">
    <h5 class="text-uppercase d-flex fs-5 text-primary"><b>D</b></h5>
    <ul class="locations">
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/dominatrix-escorts" aria-label="Dominatrix " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Dominatrix </a>
        </li>
            </ul>
</div>
<div class="colm-list-item mb-2">
    ...
    <ul class="locations">
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/english-escorts" aria-label="English " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">English </a>
        </li>
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/european-escorts" aria-label="European " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">European </a>
        </li>
            </ul>
</div>
<div class="colm-list-item mb-2">
    ...
    <ul class="locations">
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/high-class-escorts" aria-label="High Class " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">High Class </a>
        </li>
            </ul>
</div>
<div class="colm-list-item mb-2">
    ...
    <ul class="locations">
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/mature-escorts" aria-label="Mature " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Mature </a>
        </li>
            </ul>
</div>
<div class="colm-list-item mb-2">
    ...
    <ul class="locations">
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/party-escorts" aria-label="Party " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Party </a>
        </li>
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/petite-escorts" aria-label="Petite " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Petite </a>
        </li>
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/pornstar-escorts" aria-label="Pornstar " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Pornstar </a>
        </li>
            </ul>
</div>
<div class="colm-list-item mb-2">
    ...
    <ul class="locations">
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/russian-escorts" aria-label="Russian " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Russian </a>
        </li>
            </ul>
</div>
<div class="colm-list-item mb-2">
    ...
    <ul class="locations">
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/slim-escorts" aria-label="Slim " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Slim </a>
        </li>
            </ul>
</div>
<div class="colm-list-item mb-2">
    ...
    <ul class="locations">
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/video-escorts" aria-label="Video " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Video </a>
        </li>
            </ul>
</div>
<div class="colm-list-item mb-2">
    <h5 class="text-uppercase d-flex fs-5 text-primary"><b>Y</b></h5>
    <ul class="locations">
                <li class="mb-3 mb-lg-1">
            <a href="https://www.crushescorts.com/categories/young-escorts" aria-label="Young " class="text-white text-hover-primary fs-5 fs-md-down-6 d-block fonts-secondary">Young </a>
        </li>
            </ul>
</div>
                                </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="colm-list colm-xl-7 colm-lg-4">
                                    ...
                                    <div class="colm-list-item mb-2">
    <h5 class="text-uppercase d-flex fs-5 text-primary"><b>#</b></h5>
    <ul class="locations">
...
<div class="colm-list-item mb-2">
    <h5 class="text-uppercase d-flex fs-5 text-primary"><b>A</b></h5>
    <ul class="locations">
...
</div>                <div class="d-flex align-items-end flex-column desk-view">
    <a class="header-min-phone d-flex align-items-center lh-lg" href="https://wa.me/7478770704">
        <i class="fa-whatsapp"></i>
        <span class="f400">7478770704</span>
    </a>
