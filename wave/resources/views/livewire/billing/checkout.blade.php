<section>
                            ...
                            <div class="px-6 py-5 mt-auto bg-gray-50 dark:bg-neutral-700 rounded-b-xl">
                                <div class="flex items-center justify-end w-full">
                                    <div class="relative w-full md:w-auto">
                                        ...
                                        @elseif(config('wave.billing_provider') == 'pesapal')
                                            <x-billing.button x-on:click="
                                                    if(billing_cycle_selected == 'month'){ redirectToPesapal('{{ $plan->monthly_price_id }}'); }
                                                    if(billing_cycle_selected == 'year'){ redirectToPesapal('{{ $plan->yearly_price_id }}'); }
                                                "
    ...
    @elseif(config('wave.billing_provider') == 'pesapal')
        <script>
            window.redirectToPesapal = function(priceId) {
                window.location.href = '{{ url("pesapal/checkout") }}/' + priceId;
            }
        </script>
    @endif
</section>
